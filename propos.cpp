...
Propos::Propos()
{
   ...
   label = new QLabel(tr("<h2>WordBook</h2><p>Ce programme est diffusé selon les termes de la licence Creative Commons : <a href=\"http://creativecommons.org/licenses/by-nc-sa/3.0/fr/legalcode\">http://creativecommons.org/licenses/by-nc-sa/3.0/fr/legalcode</a>.<br/>Ce programme a été créé et publié par Quentin DE MUYNCK."));
